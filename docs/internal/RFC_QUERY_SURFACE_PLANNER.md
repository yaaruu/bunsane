...
**Date:** 2026-07-08
**Depends on / reads:** `docs/READ_PATH_PERFORMANCE.md` (cost-center analysis), `docs/internal/RFC_MATERIALIZED_READ_MODELS.md` (M1/M2/M3 tiers this supersedes as the *default* path), `docs/internal/RFC_ECS_PG_SORT_DENORMALIZATION.md`
