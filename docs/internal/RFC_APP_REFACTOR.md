...
**Later (2026-09-24):** `core/app/preparedStatementWarmup.ts`, listed in the module tree below, was removed. Bun SQL prepares per connection; there is no framework statement cache and no warmup step.
