...
async function main() {
    ...
    console.log(`🚀 Generating ${options.count} components with prefix "${options.prefix}"...`);
    ...
    for (let i = 1; i <= options.count; i++) {
        ...
        if (i % 20 === 0) {
            console.log(`✅ Generated ${i}/${options.count} components...`);
        }
    }
    ...
    console.log(`\n🎉 Successfully generated ${options.count} components!`);
    console.log(`\n📝 Usage:`);
